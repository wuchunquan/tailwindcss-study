            ...
            <section className="flex flex-col md:flex-row w-full  m-2 gap-2 ">
                <div className="flex flex-1 flex-col gap-4 mx-2 animate__fadeInLeft animate__animated">
                    <div className="card-shadow flex-auto gap-4" >
                        <img src={pic} className="object-cover rounded-3xl w-full h-full img-show-1"/>
                    </div>
                    <div className="flex-auto flex  flex-row gap-4 ">
                        <div className="flex-1 card-shadow filter-code-card">
                            ...
                            <img src={pic} className="object-cover rounded-3xl w-full h-full img-show-2"/>
                        </div>
                        <div className="flex-1 card-shadow filter-code-card">
                            <div className="filter-code">
                                <p >filter: hue-rotate(180deg);</p>
                            </div>
                            <img src={pic} className="object-cover rounded-3xl w-full h-full img-show-3"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto my-4">
                    ...
                    <div className="flex flex-row flex-wrap md:w-4/5 mx-auto justify-center items-center">
                        {['https://sponsors.vuejs.org/images/mqtt_x.png',
                            ...
                            'https://sponsors.vuejs.org/images/mqtt_x.png',
                            'https://sponsors.vuejs.org/images/mqtt_x.png'
                        ].map((picUrl, index) => <CompUser className="h-20 w-20 m-2 opacity-50 hover:opacity-100" picSrc={picUrl}
                                                           key={"comp-user" + index}/>)}
                    </div>
                </div>
            </section>
