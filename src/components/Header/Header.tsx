...
export default function Header({style}:{style:React.CSSProperties }) {
    ...
    return (<header className="text-3xl font-bold m-0 flex flex-row bg-gray-600 border-b-4 border-b-gray-500">
        <h1 className="mx-4 flex flex-row justify-center items-center">
